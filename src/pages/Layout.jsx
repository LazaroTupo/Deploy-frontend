            ...
            <div className="main">
                <aside className="side-bar bg-blue">
                    <nav>
                        <ul>
                            <li>
                                <Link to={'/'}><LinkButton active={location.pathname==='/'}
                                img={HomeIcon}>
                                    Home
                                </LinkButton></Link>
                            </li>
                            <li>
                                <Link to={'/profile'}><LinkButton active={location.pathname==='/profile'}
                                img={ProfileIcon}>
                                    Perfil
                                </LinkButton></Link>
                            </li>
                            <li>
                                <Link to={'/calendar'}><LinkButton active={location.pathname==='/calendar'}
                                img={CalendarIcon}>
                                    Calendario
                                </LinkButton></Link>
                            </li>
                            <li>
                                <Link to={'/patients'}><LinkButton active={location.pathname==='/patients'}
                                img={PatientsIcon}>
                                    Pacientes
                                </LinkButton></Link>
                            </li>
                            <li>
                                <Link to={'/historial'}><LinkButton active={location.pathname==='/historial'}
                                img={HistorialIcon}>
                                    Historiales Médicos
                                </LinkButton></Link>
                            </li>
